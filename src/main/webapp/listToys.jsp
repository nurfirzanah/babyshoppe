...
<div class="row">
  <% 
		...
		ResultSet resultset = statement.executeQuery("select * from product where prodtype ='toys'");
	...
	%>
      ...
      <div class="column">  
	      ...
	      <div  class="cardd">
        	...
        	<p><button><a href="toysDetails.jsp?prodId=<%=resultset.getInt("prodId")%>" style="color: inherit;text-decoration: none;">
