      ...
      <div class="right-column">
        ...
        <div class="product-configuration">
         ...
         <div class="radio-toolbar">
            <span>Size</span><br>
            <input type="radio" id="radio1" name="colour" value="blue">
            <label for="radio1">blue</label>
        
            <input type="radio" id="radio2" name="colour" value="pink">
            <label for="radio2">pink</label>
        
            <input type="radio" id="radio3" name="colour" value="white">
            <label for="radio3">white</label> 
        </div>
        <p>&nbsp;</p>
        </div>
